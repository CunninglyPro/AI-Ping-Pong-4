...
function startGame()
{
  ...
  document.getElementById("status").innerHTML = "Status: Game is Loaded!"; //Update the h3 tag which we have created inside index.html file in project 138 who has id “status” to "Game Is Loaded”.
}
